  ...
  const loadProducts = async () => {
    try {
      ...
      const response = await fetchProducts({
        product_name: searchTerm, // Using product_name filter as per your backend
        limit: 100
      });
      
      // The actual response structure is response.data.data.products
      ...
      const formattedProducts = apiProducts.map(product => ({
        ...
        ProductCategory: {
          category_name: product.ProductCategory?.category_name || 'N/A'
        },
        Brand: {
